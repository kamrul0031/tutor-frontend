...
export default function AllUsersPage() {
  ...
  return (
    ...
    <div className="bg-light-bg-1 h-screen bg-cover p-4 pt-16  flex flex-col gap-5     md:hidden">
      ...
      <div className="bg-red-00 h-full overflow-scroll flex flex-col gap-5 rounded-2xl">
        {
       users.map(() => (
        UserCard()
       ))
