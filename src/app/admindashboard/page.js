...
export default function AdminForm() {
  ...
  return (
    ...
    <div className="hidden md:block h-screen ">
      ...
      <div className="flex flex-col p-4 items-center h-full   md:hidden">
        {/* admin name section  */}
        <div className="bg-blue-00 flex gap-2 items-center w-full h-[15%] text-xl font-semibold">
        ...
        <div className="bg-blue-00 h-[50%] capitalize w-full grid gap-2 grid-cols-2">
          <div className="bg-white/50 shadow-xl max-h-[320px]:text-green-500 rounded-xl flex flex-col justify-center items-center">
            <h1 className="text-lg sm:text-red-500 font-medium">current batches</h1>
            <h1 className="font-semibold text-2xl">23</h1>
          </div>
          <div className="bg-white/50 shadow-xl max-h-[320px]:text-green-500 rounded-xl flex flex-col justify-center items-center">
            <h1 className="text-lg sm:text-red-500 font-medium">current students</h1>
